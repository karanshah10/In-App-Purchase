...
package co.peaas.inapppurchase.util;
...
public class IabHelper {
    ...
    public void launchPurchaseFlow(Activity act, String skuSub, String sku, int requestCode, OnIabPurchaseFinishedListener listener, String s)
